...
import cn.bmob.sdkdemo.sensorcontroller;
...
public class QueryStatisticActivity extends AppCompatActivity {
    ...
    public void onTest(View view){
        BmobQuery<sensorcontroller> query = new BmobQuery<>();
        query.addWhereEqualTo("SorC", true);
        query.average(new String[]{"SensorData"});
        query.groupby(new String[]{"SensorType"});
        query.findStatistics(sensorcontroller.class, new QueryListener<JSONArray>() {
            @Override
            public void done(JSONArray jsonArray, BmobException e) {
                if (e == null) {
                    Snackbar.make(view, "查询成功：" + jsonArray.length(), Snackbar.LENGTH_LONG).show();
                } else {
                    e.printStackTrace();
                }
            }
    ...
    private void statistics(View view) throws JSONException {
            ...
            public void done(JSONArray jsonArray, BmobException e) {
                if (e == null) {
                    ...
                    try {
                        ...
                        Snackbar.make(view, "sum：" + sum, Snackbar.LENGTH_LONG).show();
