...
public class FileManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnUploadSingle = findViewById(R.id.btn_upload_single);
    }
        ...
        if (permissions.size() > 0) {
            ...
            switch (requestCode) {
                ...
                case REQUEST_DELETE_SINGLE:
                    ...
                    bmobFile.setUrl("http://files.quickemart.com.cn/2020/03/23/66a147a5fb68454398ccb6ce99d7039c.png");
...
//                    deleteUserAvatar();
    ...
    private void uploadSingleFile(File file) {
        ...
        bmobFile.upload(new UploadFileListener() {
            ...
            public void done(BmobException e) {
                if (e == null) {
                    Log.d("bmob", bmobFile.getFileUrl());
        ...
        bmobFile.uploadblock(new UploadFileListener() {
            ...
            public void done(BmobException e) {
                if (e == null) {
                    ...
                    Snackbar.make(mBtnUploadSingle, "上传失败：" + e.getMessage(), Snackbar.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private void setFileToTable(BmobFile bmobFile) {
        if (!BmobUser.isLogin()) {
            Snackbar.make(mBtnUploadSingle, "请先登录", Snackbar.LENGTH_LONG).show();
        ...
        user.update(new UpdateListener() {
            ...
            public void done(BmobException e) {
                if (e == null) {
                    Snackbar.make(mBtnUploadSingle, "设置文件到表中成功", Snackbar.LENGTH_LONG).show();
                } else {
                    Snackbar.make(mBtnUploadSingle, "设置文件到表中失败：" + e.getMessage(), Snackbar.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private void downloadFile(BmobFile bmobFile) {
        ...
        bmobFile.download(saveFile, new DownloadFileListener() {
            ...
            @Override
            public void onStart() {
                Snackbar.make(mBtnUploadSingle, "开始下载:" + bmobFile.getFileUrl(), Snackbar.LENGTH_LONG).show();
            }
