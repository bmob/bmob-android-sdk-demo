...
//                String bql = "select * from Machine where location = geopoint(117.150464,34.220113)";
//                String bql = "select * from Machine where location near geopoint(117.150049,34.220113) max 1 km";
//                String bql = "select * from Machine where location near [117.145438,34.216759] max 1 km";
//                BmobQuery<Machine> query1 = new BmobQuery<>();
//                query1.setSQL(bql);
//                query1.doSQLQuery(new SQLQueryListener<Machine>() {
//                    @Override
//                    public void done(BmobQueryResult<Machine> bmobQueryResult, BmobException e) {
//                        if (e == null) {
//                            List<Machine> list = bmobQueryResult.getResults();
//                            for (Machine m : list) {
//                                Log.d("bmob success", "done: " + m.repr());
//                            }
//                        } else {
//                            Log.d("bmob fail", "done: " + e.getErrorCode() + " " + e.getMessage());
//                        }
//                    }
//                });
