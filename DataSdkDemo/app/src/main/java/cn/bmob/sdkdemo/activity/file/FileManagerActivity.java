        ...
        switch (requestCode) {
            case REQUEST_UPLOAD_SINGLE:
                if (resultCode == RESULT_OK) {
                    Log.e("BMOB", UriUtils.getRealPathFromUri(this, data.getData()));
                    uploadSingleFile(new File(UriUtils.getRealPathFromUri(this, data.getData())));
                }
                break;
            case REQUEST_UPLOAD_SINGLE_TO_TABLE:
                if (resultCode == RESULT_OK) {
                    Log.e("BMOB", UriUtils.getRealPathFromUri(this, data.getData()));
                    uploadSingleFileToTable(new File(UriUtils.getRealPathFromUri(this, data.getData())));
                }
                break;
            default:
                break;
